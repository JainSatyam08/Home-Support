 ...
 * @author DELL
 */
public class Updateconfirmframe extends javax.swing.JFrame {

    /**
     * Creates new form Updateconfirmframe
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Updateconfirmframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
